...
#End Region
    ...
    Private Sub btnTotal_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnTotal.Click
        ...
        Dim intNumberOfPizzas As Integer, intNumberOfSalads As Integer, intNumberOfBeverages As Integer
        Dim decTotal As Decimal

        intNumberOfPizzas = Val(Me.txtPizzaOrders.Text)
        intNumberOfSalads = Val(Me.txtSaladOrders.Text)
        intNumberOfBeverages = Val(Me.txtBeverageOrders.Text)
        decTotal = CheckTotal(intNumberOfPizzas, intNumberOfSalads, intNumberOfBeverages)
